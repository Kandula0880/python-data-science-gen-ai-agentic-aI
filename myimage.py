...
@st.cache_data
def load_image():
    path = r"E:\VS CODE\0.Image Analysis\WhatsApp Image 2026-02-15 at 10.32.54.jpg"
    img = Image.open(path).convert("RGB")
    img = img.resize((800, 600))  # width, height
    return img

#Load and dispaly Image
elephant = load_image()
st.image(elephant,caption="Original kasi Image",use_container_width=True)
